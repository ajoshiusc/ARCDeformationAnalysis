...
Stroke Registration Asymmetry: Numerical Robustness and Aphasia Associations
in the Aphasia Recovery Cohort'' for publication in \emph{Imaging
Neuroscience}.
...
for conventional clinical and lesion variables and multiplicity. Neither
feature family established incremental nested cross-validated prediction of
Western Aphasia Battery Aphasia Quotient. The complete nonsignificant and
sensitivity results are reported in the Supplementary Material. This pattern
defines both the reproducible information in the registration geometry and its
current limit as an independent behavioral marker.
